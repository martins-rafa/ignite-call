...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine((intervals) => intervals.length > 0, {
      message: 'At least 1 day of the week should be selected',
    })
    .transform((intervals) => {
    ...
    .refine(
      ...
      {
        message: 'Time intervals should be at least 1 hour long',
      },
    ),
})
    ...
    <>
      ...
      <Container>
        <Header>
          ...
          <Text>Set your available time intervals for each day.</Text>
